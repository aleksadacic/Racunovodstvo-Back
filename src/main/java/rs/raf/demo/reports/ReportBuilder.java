...
public class ReportBuilder {
     ...
     */
    public static ByteArrayOutputStream generateTableReport(String author, String title, List<List<String>> rows, List<String> columns, String footer) throws DocumentException {
